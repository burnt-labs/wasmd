...
// version 4 to version 5. This migration re-serializes all ContractInfo
// records to ensure compatibility with the updated schema that includes
// the ibc2_port_id field added in wasmd v0.61.5.
func (m Migrator) Migrate4to5(ctx sdk.Context) error {
	return v4.NewMigrator(m.keeper.mustStoreContractInfo).Migrate4to5(ctx, m.keeper.storeService, m.keeper.cdc)
}
